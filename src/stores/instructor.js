...
export const useInstructorStore = defineStore("instructor", {
  ...
  getters: {
    module: (store) => ({
      name: "Instructors",
      label: store.$t("label.instructors"),
      singular: store.$t("singular.instructor"),
      plural: store.$t("plural.instructors"),
    }),
    columns: (store) => [
      {
        name: "name",

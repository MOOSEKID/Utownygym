    ...
    <base-section class="cart-section" flat bordered :title="$t('cart')" no-row>
          ...
          <q-item-section>
            <q-item class="q-px-none">
              <q-item-section>
                ...
                <q-item-label>
                  {{ $core.money(props.row.price) }} x {{ props.row.quantity }}
                </q-item-label>
              </q-item-section>
              <q-item-section side>
                <q-item-label>
                ...
                <div class="meta items-center flex">
                  <div class="price text-bold q-mr-md">
                    {{ $core.money(props.row.quantity * props.row.price) }}
                  </div>
                  <base-btn
                    flat
                    dense
      ...
      <template v-if="cartCount" #bottom>
        <div class="flex items-center">
          ...
          <div :class="{ 'text-right': true, 'full-width': $q.screen.xs }">
            <base-btn
              size="md"
              caps
              color="primary"
              :label="$t('submitCart')"
              :class="{ 'q-mt-md': true, 'full-width': $q.screen.xs }"
              cap
              :loading="submited"
              @click="onSubmitCart"
            />

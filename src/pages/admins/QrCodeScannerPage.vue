  ...
  <q-page padding>
    ...
    >
      <div class="col-sm-9 col-xs-12">
        <base-section bordered v-if="loaded" class="user-details">
          ...
          <div class="col-xs-12 col-sm-8">
            <div class="row q-col-gutter-md">
              ...
              <div class="col-xs-12">
                ...
                <current-plan-card class="q-mb-md" :user="member" no-action />
              </div>
            </div>
          </div>
        </base-section>
...
export default {
  ...
  methods: {
    ...
    onDetect(val) {
      if (this.loading || this.currentCode == val) return;
      ...
      this.showByQrcode(val)
        .then(async (member) => {
          ...
          await this.setUser(member, true);

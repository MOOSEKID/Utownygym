...
class InstructorController extends Controller
{
    ...
    public function index(Request $request, Instructor $instructor)
    {
        ...
        $instructor = $instructor->sortBy($request->sortBy ?? 'created_at', $request->direction ?? 'desc')
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroySelected(Request $request, Instructor $instructor)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function restoreSelected(Request $request, Instructor $instructor)
    {
        $this->validate($request, [
            'items' => 'required',
        ]);

    ...
    <main>
                ...
                <tr>
                    <td>
                        <table cellspacing="0" class="active-table table">
                            ...
                            <tbody>
                                ...
                                @for ($id = 1; $id <= 5; $id++)
                                    @php
                                        $booking = isset($stand_by_bookings[$id - 1])
                                            ? $stand_by_bookings[$id - 1]
                                            : false;
                                    @endphp
                                    @if ($booking)
                                        <tr>
                    ...
                    <td style="width:120px; padding: 15px" rowspan="4" valign="top">
                        <div style="position: relative">
                            {{ config('app.name') }} Sign off <input id="signed-off" type="checkbox"
                                disabled="disabled" @if ($classSchedule->has_sign_off) checked="checked" @endif />
                        </div>
        ...
        <table cellspacing="0">
            <tbody>
                ...
                <tr>
                    <td>{{ config('app.name') }} Staff Sign off:</td>
                    <td style="width: 110px;">
                        <input type="text">
                    </td>
                </tr>

...
class AnnouncementController extends Controller
{
    ...
    public function index(Request $request, Announcement $announcement)
    {
        ...
        $announcement = $announcement->orderBy($request->sortBy ?? 'created_at', $request->direction ?? 'desc')
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroySelected(Request $request, Announcement $announcement)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function restoreSelected(Request $request, Announcement $announcement)
    {
        $this->validate($request, [
            'items' => 'required',
        ]);

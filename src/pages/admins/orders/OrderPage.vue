    ...
    <base-page-toolbar v-if="loaded && !creating" class="q-mb-md">
      <template v-slot:title>
        ...
        <div class="text-subtitle2">
          {{ $core.formatDateAsHuman(order.created_at) }} from
          {{ order.source }}
        </div>
      </template>
      ...
      <div class="row q-col-gutter-md">
        <div class="col-xs-12 col-sm-9">
          <div class="q-gutter-md">
            <products-card
              ...
              :can-edit="order.can_edit && !creating"
              ...
              bordered
            />
            <base-section bordered title="Billing details" no-row>
              <billing-details
                :view="!edit"
                ref="billing"
                has-payment
        ...
        <div class="col-xs-12 col-sm-3">
          <div class="q-gutter-md">
            ...
            />
            <base-section bordered title="Notes" no-row>
              <div class="note">
...
export default {
  ...
  mounted() {
    if (!this.creating) {
      ...
      Object.assign(this.order, { currency: this.config?.currency });
      Object.assign(this.default, { currency: this.config?.currency });
      this.loaded = true;
    }
  },
  computed: {

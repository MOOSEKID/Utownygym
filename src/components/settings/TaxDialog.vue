    ...
    <template v-slot:body>
      <base-section flat>
        <div class="col-xs-12 col-sm-4">
          <base-label required>{{ $t("label.country") }}</base-label>
          <country-select
        ...
        <div class="col-xs-12 col-sm-4">
          <base-label required>{{ $t("label.state") }}</base-label>
          <state-select
            :readonly="tax.removeable"
            v-model="tax.state"
            :country="tax.country"
        ...
        <div class="col-xs-12 col-sm-3">
          <base-label required>{{ $t("label.rate") }}</base-label>
          <base-input
            v-model="tax.rate"
            type="number"
            min="0"
        ...
        <div class="col-xs-12 col-sm-3">
          <base-label>{{ $t("label.priority") }}</base-label>
          <base-input
            debounce="500"

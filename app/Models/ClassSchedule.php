...
class ClassSchedule extends Model
{
    ...
    /**
     * Get the date_time_formated
     */
    public function getDateTimeFormatedAttribute()
    {
        return $this->date_at->format('d/m/Y \a\t h:i a');
    }

    public function getTitle()
    {
        return $this->instructor ? "{$this->class->name} - {$this->instructor->name}" : $this->class->name;
    }
    ...
    {
        $this->confirmBooking(User::find($order->customer_id));
    }

    public function title()
    {
        return $this->location ? "{$this->class->name} - {$this->location->label}" : $this->class->name;
    }
